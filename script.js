...
document.addEventListener('DOMContentLoaded', function () {
  ...
  downloadCVBtn.addEventListener('click', function () {
    ...
    const cvContent = `
            ...
            Portfolio: https://navinkumarportfolio.com
            GitHub: https://github.com/navinkumar
            ...
            Contact: ck0424884@gmail.com
            LinkedIn: linkedin.com/in/navinkumar
  ...
  hireMeBtn.addEventListener('click', function () {
    alert('Thank you for your interest! Please contact me at ck0424884@gmail.com for hiring inquiries.');
  });

  contactMeBtn.addEventListener('click', function () {
    alert('Contact me at:\nEmail: ck0424884@gmail.com\nPhone: +91 9771541226 \nLinkedIn: https://www.linkedin.com/in/navin-kumar-373399341?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app \nGitHub: https://github.com/Navinkumarbth \nInstagram: https://www.instagram.com/navin_nk_07?igsh=MWFpaDduNHd0ZnJ1Mw==');
  });
  ...
  socialLinks.forEach((link, index) => {
    ...
    link.addEventListener('click', function (e) {
      ...
      if (platform.includes('facebook')) {
        url = 'https://www.facebook.com/share/172C8tKoYz/';
      } else if (platform.includes('twitter')) {
        url = 'https://x.com/Navinkumar7480?t=FHRQ_xvbAjGzS4Shzt4mkA&s=09';
      } else if (platform.includes('instagram')) {
        url = 'https://www.instagram.com/navin_nk_07?igsh=MWFpaDduNHd0ZnJ1Mw==';
      } else if (platform.includes('linkedin')) {
        url = 'https://www.linkedin.com/in/navin-kumar-373399341?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app';
      } else if (platform.includes('github')) {
        url = 'https://github.com/Navinkumarbth';
      }
